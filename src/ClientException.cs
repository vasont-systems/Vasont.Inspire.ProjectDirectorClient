...
namespace Vasont.Inspire.ProjectDirector.Client
{
    ...
    public class ClientException : Exception
    {
        ...
        public ClientException(ProjectDirectorConfigurationModel config, string message = "", Exception innerException = null)
        ...
        /// </value>
        public ProjectDirectorConfigurationModel ClientConfiguration { get; }
    }
}
